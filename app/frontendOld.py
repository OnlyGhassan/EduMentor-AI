...
#                             pdf_link = f'<a href="data:application/pdf;base64,{pdf_base64}" download="quiz_report.pdf">⬇ Download PDF Report</a>'
...
#         # --- Text input area ---
#         text_grammar = st.text_area("✏ Text to check:", height=180)
